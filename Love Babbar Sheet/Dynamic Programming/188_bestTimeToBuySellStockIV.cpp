...
// Ab isme ek aur parameter aagya ki k at most transaction jaise hi hoga return 0....ab transaction complete buy pr nhi hoga sale kr hoga...as buy pr kroge to wo sale nhi to profit kha
...
int maxProfit(int k, vector<int> &prices)
{
    ...
    for (int ind = n - 1; ind >= 0; ind--)
    {
        ...
        {
            // Trans k se 0 horha to yha opposite hoga 1 se k...0 is saved
...
{
    int n = prices.size();
    // 3 Parameters h ek ind aur ek buy ya sell and ek trans...jo k to 0 jayega
...
int maxProfit(int k, vector<int> &prices)
{
    ...
    return stockSeller(prices, n, 0, 1, dp, k);
}
...
{
    // Start 0 se hi hoga as hum buy krenge tb sell krenge
    return stockSeller(prices, prices.size(), 0, 1, k);
}
